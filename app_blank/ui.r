    ...
    fluidRow(
        ...
        column(4, 
               ...
               div(class = 'row2',
                   ...
                   column(4, uiOutput('cs_min')),
                   column(4, uiOutput('cs_max')))
               ),
        column(4, 
               div(class = 'row2',
                   column(4, h6(' ')),
        ...
        column(3, 
               ...
               fluidRow(
                   ...
                   column(9, numericInput("nsamples", 
                            label = NULL,
                            value = 5000, min = 100, max = 1e6, step = 100, width = '50%')))
               ),
        column(3, 
               align = 'top',
    ...
    fluidRow(
        ...
        column(3, 
            ...
            The impact of the threat may be 
                specified as a change in the corresponding parameter, or as a number of individuals. To remove a threat, set its impact to zero.")
               ),
        column(8,
               tags$div(
